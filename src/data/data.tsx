...
import porfolioImage5 from '../images/portfolio/netspar.jpeg';
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        ...
        <br></br>
        Website: <a href="https://nvca.org/employment-dynamics/">https://nvca.org/employment-dynamics/</a>.
        <br></br><br></br>
        ...
        <br></br>
        Website: <a href="https://uncipc.org/index.php/publication/performance-analysis-and-attribution-with-alternative-investments/">link to the white paper</a>. 
        <br></br><br></br>
  ...
  },
  {
    ...
    content: (
      <p>
        Collected and analyzed data for the COVID-19 Decision Dashboard, a 'real-time' research project commissioned by the Governor to advise on North Carolina's response to the pandemic, focusing on economic activity and business operations. 
        <br></br>
        Constructed and estimated a time-varying Markov model to forecast COVID-19 cases in North Carolina.
        <br></br>
        Website: <a href="https://kenaninstitute.unc.edu/dashboard/reopening-amid-covid-19/">https://kenaninstitute.unc.edu/dashboard/reopening-amid-covid-19/</a>.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Investigated intergenerational equity in the Canadian implementation of risk-sharing pension plans using a Value-Based Asset Liability Management framework.
        <br></br>
        Implemented a web application available at: <a href="https://retirement.shinyapps.io/targetbenefitplan/">https://retirement.shinyapps.io/targetbenefitplan/</a>.
      </p>
    ),
  },
  {
